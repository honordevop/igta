      ...
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <div className="container">
          <div className="w-full my-20 text-center flex flex-col gap-4 items-center justify-center">
            ...
            <p className="text-xl">
              As your full-fledged partner for innovation, education, and
              capacity building, we support you in creating long-lasting
              solutions that advance fairness and decent work environment.
            </p>
          </div>
