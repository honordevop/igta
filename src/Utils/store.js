...
export const results = [
  { name: "Taiwo Solomon Ajisafe", score: "96%" },
  { name: "Oladapo Teminioluwa Emmanuel", score: "93%" },
  { name: "Onyemelukwe Godson Chinedu N", score: "92%" },
  { name: "Onochie Chukwuma Alexander", score: "91%" },
  { name: "Benjamin David Monday", score: "90%" },
  { name: "Luka Yakubu Garingaye", score: "89%" },
  { name: "Duran Tabi Tambia", score: "87%" },
  { name: "Angela Omogbeme", score: "85%" },
  { name: "Ikarogie Joy Ewens", score: "82%" },
  { name: "Abayomi Adewale Matthew", score: "77%" },
  { name: "Ibrahim Mohammed Jamilu", score: "75%" },
  { name: "Beke Tombra Suobor", score: "74%" },
  { name: "Okpara Emmanuel", score: "71%" },
  { name: "Adedokun Yusuf Adebiyi", score: "70.5%" },
  { name: "Adesina Afolabi Olaposi", score: "70%" },
  { name: "Rickson Andake", score: "69%" },
  { name: "Ogunronbi Elizabeth Opeyemi", score: "68%" },
  { name: "Onyilo Emmanuel Edache", score: "67%" },
  { name: "Asuquo Edet Essang", score: "66%" },
  { name: "Sholaja Sulaimon Oladiti", score: "65.5%" },
  { name: "Ogedengbe Zachaeus Ayomide", score: "65%" },
  { name: "Yusuf Moshood Olayinka", score: "64%" },
  { name: "Alaafin Mariam Ayokunmi", score: "63%" },
  { name: "Aju David Ikor", score: "62%" },
  { name: "Alifa Saratu Ahmed", score: "60%" },
];

export const oldresults2 = [
