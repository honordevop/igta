...
const UpdateNoteFormm = ({ id, hideUpdateEventForm, mutate }) => {
    ...
    <div className="w-full h-screen absolute top-0 left-0 bg-[#00000086]  flex items-center justify-center">
      {!loading && !regSuccess && (
        <div className="w-full pb-8 flex flex-col items-center justify-center h-full">
          <div className="realtive bg-white w-5/6 md:w-3/4 lg:w-3/4 xl:w-3/4 2xl:w-3/4 mt-8 mx-0 md:mx-auto px-4 md:px-16 py-8 rounded-lg shadow-2xl overflow-auto">
...
export default UpdateNoteFormm;
